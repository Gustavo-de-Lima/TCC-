        ...
        if (resultado != null && resultado.size() > 0)
        {
            ...
            for (int i = 0; i < resultado.size(); i++) 
            {
                ...
                if (produto != null) 
                {
                    ...
                    dadosTabela[2] = produto.getQuant();
                    dadosTabela[3] = produto.getValorUnitario();
...
//==============================================================================     
    ...
    private void produtoTabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_produtoTabelaMouseClicked
        ...
        produto.setQuant((Integer) produtoTabela.getValueAt(row, 2));
        produto.setValorUnitario((Double) produtoTabela.getValueAt(row, 3));
